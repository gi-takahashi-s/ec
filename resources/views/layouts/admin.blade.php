        ...
        <div class="flex flex-col min-h-screen">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 flex items-center">
                                ...
                                @if($shopDisplay['type'] === 'logo')
                                    <!-- <img src="{{ $shopDisplay['value'] }}" alt="{{ $shopDisplay['alt'] }}" class="h-8 w-auto mr-4"> -->
                                    <span class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ $shopDisplay['alt'] }} 管理</span>
                                @else
                                    <span class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ $shopDisplay['value'] }} 管理</span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="block md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-10">
                <div class="grid grid-cols-6 gap-1">
                    ...
                    <a href="{{ route('admin.system.info') }}" class="flex flex-col items-center justify-center p-2 {{ request()->routeIs('admin.system.*') ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400' }}">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="text-xs mt-1">システム</span>
                    </a>
                </div>
            </div>
        </div>
