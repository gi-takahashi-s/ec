        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @php
                $breadcrumbItems = [
                    ...
                    ['title' => '商品一覧', 'url' => route('products.index')]
                ];
                
                if($product->category) {
                    $breadcrumbItems[] = ['title' => $product->category->name, 'url' => route('categories.show', $product->category->slug)];
                }
                
                $breadcrumbItems[] = ['title' => $product->name, 'current' => true];
            @endphp
