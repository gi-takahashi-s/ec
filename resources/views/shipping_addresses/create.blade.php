                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('shipping_addresses.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="postal_code" class="block mt-1 w-full md:w-1/3" type="text" name="postal_code" :value="old('postal_code')" required placeholder="1234567" />
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full md:w-1/2" type="text" name="phone" :value="old('phone')" required placeholder="09012345678" />
                        </div>
