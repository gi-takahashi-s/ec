                    ...
                    <form action="{{ route('shipping_addresses.update', $shippingAddress) }}" method="POST">
                        ...
                        <div class="mb-6">
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="is_default" value="1" {{ old('is_default', $shippingAddress->is_default) ? 'checked' : '' }}>
