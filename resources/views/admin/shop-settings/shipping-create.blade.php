    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">配送業者追加</span>
            </div>
        </li>
    </ol>
</nav>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">配送方法名称 <span class="text-red-500">*</span></label>
                    <input type="text" name="method_name" value="{{ old('method_name') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <label class="inline-flex items-center">
                    <input type="checkbox" name="payment_methods[]" value="{{ $key }}"
                        {{ in_array($key, old('payment_methods', [])) ? 'checked' : '' }}
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <div id="deliveryTimesContainer">
                @if(old('delivery_times'))
                @foreach(old('delivery_times') as $time)
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                ...
                <div class="flex space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="uniform_shipping_fee" value="1"
                            {{ old('uniform_shipping_fee', '0') === '1' ? 'checked' : '' }}
                    ...
                    <label class="inline-flex items-center">
                        <input type="radio" name="uniform_shipping_fee" value="0"
                            {{ old('uniform_shipping_fee', '0') === '0' ? 'checked' : '' }}
                            onchange="toggleUniformFee()" class="form-radio text-indigo-600 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-700">
            ...
            <!-- 全国一律料金 -->
            <div id="uniformFeeContainer" class="mb-4 {{ old('uniform_shipping_fee', '0') === '1' ? '' : 'hidden' }}">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">全国一律送料（円）</label>
                <input type="number" name="uniform_fee" value="{{ old('uniform_fee') }}" min="0" step="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
            </div>

            <!-- 都道府県別料金 -->
            <div id="prefectureFeesContainer" class="{{ old('uniform_shipping_fee', '0') === '0' ? '' : 'hidden' }}">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="prefecture_fees[{{ $prefecture }}]"
                            value="{{ old('prefecture_fees.' . $prefecture) }}"
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <div>
                ...
                <textarea name="notes" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white">{{ old('notes') }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <label class="inline-flex items-center">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="form-checkbox text-indigo-600 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-700">
